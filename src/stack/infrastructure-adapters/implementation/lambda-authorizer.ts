import { APIGatewayAuthorizerEvent, APIGatewayRequestAuthorizerEvent, APIGatewayAuthorizerResultContext, APIGatewayAuthorizerWithContextResult } from "aws-lambda";
...
interface AuthorizationGrantedContext extends APIGatewayAuthorizerResultContext {
...
type AuthorizationContext = AuthorizationGrantedContext | AuthorizationDeniedContext;
...
export const create: <Payload>(deps: Dependencies<Payload>) => (event: APIGatewayRequestAuthorizerEvent) => Promise<APIGatewayAuthorizerWithContextResult<AuthorizationContext>> = (deps) => {
